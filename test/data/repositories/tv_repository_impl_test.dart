...
import 'package:movic/common/failure.dart';
import 'package:movic/data/models/genre_model.dart';
import 'package:movic/data/models/tv/tv_detail_response.dart';
import 'package:movic/data/models/tv/tv_model.dart';
import 'package:movic/data/repositories/tv_repository_impl.dart';
...
void main() {
  ...
  group("now playing tv series", () {
    test(
      "should return data when call to remote data source is success",
      () async {
        // arrange
        when(
          mockTvRemoteDataSource.getNowPlayingTvSeries(),
    ...
    test(
      ...
      () async {
        ...
        when(
          mockTvRemoteDataSource.getNowPlayingTvSeries(),
        ).thenThrow(const SocketException("Failed to connect to the internet"));
  ...
  group('Get Tv Detail', () {
    ...
    test(
      ...
      () async {
        // arrange
        when(
          mockTvRemoteDataSource.getTvDetail(tId),
  ...
  group('Get Tv Recommendations', () {
    ...
    test('should return data (tv list) when the call is successful', () async {
      // arrange
      when(
        mockTvRemoteDataSource.getTvRecommendations(tId),
  ...
  group('Seach Tv Series', () {
    ...
    test(
      ...
      () async {
        // arrange
        when(
          mockTvRemoteDataSource.searchTvSeries(tQuery),
        ).thenAnswer((_) async => tTvModelList);
        // act
  ...
  group('save watchlist', () {
    test('should return success message when saving successful', () async {
      // arrange
      when(
        mockTvLocalDataSource.insertTvWatchlist(testTvTable),
  ...
  group('remove watchlist', () {
    test('should return success message when remove successful', () async {
      // arrange
      when(
        mockTvLocalDataSource.removeTvWatchlist(testTvTable),
  ...
  group('get watchlist tv series', () {
    test('should return list of tv series', () async {
      // arrange
      when(
        mockTvLocalDataSource.getWatchlistTvSeries(),
